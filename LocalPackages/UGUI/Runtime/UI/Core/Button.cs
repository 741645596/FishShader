...
namespace UnityEngine.UI
{
    ...
    public class Button : Selectable, IPointerClickHandler, ISubmitHandler
    {
        ...
        {
            base.Awake();
            buttonScaleData = new ButtonScaleData();
            buttonScaleData.ClickScale = 0.9f;
            buttonScaleData.EnableScale = enableScale;
        }
        ...
        public void SetClickScale(float s)
        {
            if (s <= 0)
            {
                buttonScaleData.EnableScale = false;
            }
            else
            {
                buttonScaleData.EnableScale = true;
            }
            buttonScaleData.ClickScale = s;
        }
