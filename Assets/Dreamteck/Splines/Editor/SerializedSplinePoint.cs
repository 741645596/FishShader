namespace Dreamteck.Splines.Editor
{
    ...
    public struct SerializedSplinePoint
    {
        ...
        public float time
        {
            get { return _time.floatValue; }
            set
            {
                if (value != time)
                {
                    _time.floatValue = value;
                    changed = true;
                }
            }
        }
        ...
        public int playani
        {
            get { return _playani.intValue; }
            set
            {
                if (value != playani)
                {
                    _playani.intValue = value;
                    changed = true;
                }
            }
        }
        ...
        public int movetype
        {
            get { return _movetype.intValue; }
            set
            {
                if (value != movetype)
                {
                    _movetype.intValue = value;
                    changed = true;
                }
            }
        }
        ...
        private SerializedProperty _playani;
        ...
        public SerializedSplinePoint(SerializedProperty input)
        {
            ...
            _time = _point.FindPropertyRelative("time");
            _playani = _point.FindPropertyRelative("playani");
            _movetype = _point.FindPropertyRelative("movetype");
        ...
        private void CheckForChange(SplinePoint point)
        {
            ...
            if (movetype != point.movetype)
            {
                changed = true;
                return;
            }

            if (playani != point.playani)
            {
                changed = true;
                return;
            }
