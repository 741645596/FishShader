...
Shader "fish/fx/fx_wenliliudong_alpha_test 20201214"
{
	Properties
	{
		...
		_Mask_01_Offset_U("Mask_01_Offset_U", Float) = 0
		_Mask_01_Offset_V("Mask_01_Offset_V", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color0;
			half _colorliangdu;
			half _Mask_01_Offset_U;
			half _Mask_01_Offset_V;
			CBUFFER_END
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half2 appendResult56 = (half2(_Mask_01_Offset_U , _Mask_01_Offset_V));
				half2 uv055 = IN.ase_texcoord1.xy * float2( 1,1 ) + appendResult56;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2DNode25 * ( _Color0 * _colorliangdu ) * IN.ase_color ).rgb;
				float Alpha = ( tex2DNode25.a * tex2D( _mask_01, uv055 ).a * IN.ase_color.a * _Color0.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 tex2DNode25 = tex2D( _wenli, panner24 );
				half2 appendResult56 = (half2(_Mask_01_Offset_U , _Mask_01_Offset_V));
				half2 uv055 = IN.ase_texcoord.xy * float2( 1,1 ) + appendResult56;
...
/*ASEBEGIN
Version=17500
1934;37;1906;993;1144;424.1924;1.452318;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-946.1182,831.2349;Inherit;False;Property;_Mask_01_Offset_V;Mask_01_Offset_V;9;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-947.418,718.1353;Inherit;False;Property;_Mask_01_Offset_U;Mask_01_Offset_U;8;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;56;-656.2179,673.9352;Inherit;True;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;55;-388.4179,514.0352;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;42;-101.7727,607.4543;Inherit;True;Property;_mask_01;mask_01;6;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;41;52.11978,403.3537;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;44;-1347.447,399.3202;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-1167.117,528.3348;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;45;-1117.051,674.9467;Float;False;Property;_maskspeed;mask speed;7;0;Create;True;0;0;False;0;1,10;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;53;-1342.32,534.9019;Float;False;Property;_wenli_Tinling_m;wenli_Tinling_m;4;1;[HDR];Create;True;0;0;False;0;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;43;-811.3397,464.7888;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-0.3;False;1;FLOAT;1;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=23381BFEF8B68E09B11C24FC0627ED75ED6F1F91