...
Shader "fish/fx/fx_wenliliudong_alpha"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 panner24 = ( 1.0 * _Time.y * _wenlispeed + ( IN.ase_texcoord1.xy * _wenli_Tinling ));
				float4 tex2DNode25 = tex2D( _wenli, panner24 );
				
				float2 panner43 = ( 1.0 * _Time.y * _maskspeed + IN.ase_texcoord1.xy);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner24 = ( 1.0 * _Time.y * _wenlispeed + ( IN.ase_texcoord.xy * _wenli_Tinling ));
				float4 tex2DNode25 = tex2D( _wenli, panner24 );
				float2 panner43 = ( 1.0 * _Time.y * _maskspeed + IN.ase_texcoord.xy);
...
/*ASEBEGIN
Version=17500
712;311;1286;980;1187.267;214.6148;1.3;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;48;767.7709,77.13494;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;fish/fx/fx_wenliliudong_alpha;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;0;Forward;7;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;10;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;0;Receive Shadows;0;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;Meta Pass;0;Vertex Position,InvertActionOnDeselection;1;0;4;True;False;True;False;False;;0
...
ASEEND*/
//CHKSM=33887895D7923A6D2A072D12CE81CE67239DA327