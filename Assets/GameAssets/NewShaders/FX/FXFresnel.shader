    ...
    SubShader {
        ...
        Pass {
            ...
            Varyings vert(Attributes input)
            {
                ...
                // float3 posWS = TransformObjectToWorld(input.vertex);
                // float3 normalWS = TransformObjectToWorldNormal(input.normal);
                // half3 viewDirWS = GetCameraPositionWS() - posWS;
            ...
            half4 frag(Varyings in_f) : SV_TARGET
            {
                ...
                // float4 fresClr = in_f.fresnel * _FresnelColor;
                //col.rgb += fresClr;
