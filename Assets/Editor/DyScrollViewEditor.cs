...
namespace AillieoUtils
{
    ...
    [CustomEditor(typeof(DyScrollView))]
    public class DyScrollViewEditor : ScrollRectEditor
    {
        ...
        protected virtual void DrawConfigInfo()
        {
            ...
            layoutType.intValue = (int)(DyScrollView.ItemLayoutType)EditorGUILayout.EnumPopup("layoutType", (DyScrollView.ItemLayoutType)layoutType.intValue);
        }
        ...
        [MenuItem("GameObject/UI/DyScrollView", false, 90)]
        static public void AddScrollView(MenuCommand menuCommand)
        {
            InternalAddScrollView<DyScrollView>(menuCommand);
        }

        protected static void InternalAddScrollView<T>(MenuCommand menuCommand) where T : DyScrollView
        {
            ...
            DyScrollView scrollRect = root.AddComponent<T>();
