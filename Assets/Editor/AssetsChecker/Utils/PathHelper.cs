...
namespace EditerUtils
{
    ...
    public static class PathHelper
    {
        ...
        // ILRuntime的 CLR Binding 生成文件的绝对路径
        public static readonly string ILRuntime_Dir_Path = Application.dataPath + "/ILRuntime/Generated";

        // ILRuntime的 CLR Binding 生成文件在unity内的相对路径
        public static readonly string ILRuntime_Unity_Path = "Assets/ILRuntime/Generated";
