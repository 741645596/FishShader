...
public class UnreferencedResourceCheckEditorWindow : AssetCheckEditorWindowBase<UnreferencedResourceInfo>
{
    ...
    private static string _filterSuffix = ".json;.mp3;.ttf;.txt";
    ...
    private void _ShowToggleLogic()
    {
        ...
        _isFilter = EditorGUILayout.ToggleLeft("隐藏prefab", _isFilter); // 隐藏prefab,默认勾选
        ...
        //if (GUILayout.Button("查找代码引用", GUILayout.Width(100)))
        //{
        //    var unreferencedTab = GetWindow<UnreferencedScriptCheckEditorWindow>(typeof(AssetsCheckEditorWindow));
        //    unreferencedTab.InitAssetInfos(_assetsInfos);
    ...
    protected override List<UnreferencedResourceInfo> OnGetShowInfos()
    {
        ...
        return _isFilter ? UnreferencedResourceChecker.GetHidePrefabs(showInfos) : showInfos;
    }
}
